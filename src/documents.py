...
_MEDIA_TYPES: dict[str, frozenset[str]] = {
    ...
    ".dot": frozenset({"application/msword", "text/vnd.graphviz"}),
    ".dotm": frozenset({"application/vnd.ms-word.template.macroenabled.12"}),
    ".dotx": frozenset({"application/vnd.openxmlformats-officedocument.wordprocessingml.template"}),
    ...
    ".otp": frozenset({"application/vnd.oasis.opendocument.presentation-template"}),
    ".ots": frozenset({"application/vnd.oasis.opendocument.spreadsheet-template"}),
    ".ott": frozenset({"application/vnd.oasis.opendocument.text-template"}),
    ".pages": frozenset({"application/x-iwork-pages-sffpages"}),
    ".pot": frozenset({"application/vnd.ms-powerpoint"}),
    ".potm": frozenset({"application/vnd.ms-powerpoint.template.macroenabled.12"}),
    ".potx": frozenset({"application/vnd.openxmlformats-officedocument.presentationml.template"}),
    ...
    ".xlsb": frozenset({"application/vnd.ms-excel.sheet.binary.macroenabled.12"}),
